  ...
  <div class="min-h-screen flex items-center justify-center p-4" style="background: linear-gradient(to bottom right, #FFFFF0, #D9E9CF);">
    <div class="w-full max-w-md">
      ...
      <div class="card" style="background-color: #FFFFFF; border: 2px solid #D9E9CF; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.1); border-radius: 1rem;">
        <div class="card-body">
          <h2 class="card-title text-2xl mb-6 justify-center" style="color: #FEA405;">Create Account</h2>
          ...
          <form @submit.prevent="handleSignup" class="space-y-4">
              ...
              <div class="grid grid-cols-3 gap-2">
                <label 
                  ...
                  :style="selectedRole === 'manager' 
                    ? 'border-color: #FEA405; background-color: #FFF5F0;' 
                    : 'border-color: #D9E9CF; background-color: white;'"
                >
                  <input 
                    type="radio" 
                  ...
                  <div class="flex flex-col items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mb-1" :style="selectedRole === 'manager' ? 'color: #FEA405;' : 'color: #FEA405;'" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    </svg>
                    <span class="text-xs font-medium" :style="selectedRole === 'manager' ? 'color: #FEA405;' : 'color: #000000;'">Manager</span>
                  </div>
                </label>
                ...
                >
                  ...
                  />
                  <div class="flex flex-col items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mb-1" :style="selectedRole === 'staff' ? 'color: #FEA405;' : 'color: #FEA405;'" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <span class="text-xs font-medium" :style="selectedRole === 'staff' ? 'color: #FEA405;' : 'color: #000000;'">Staff</span>
                  </div>
                </label>
                ...
                >
                  ...
                  />
                  <div class="flex flex-col items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mb-1" :style="selectedRole === 'customer' ? 'color: #FEA405;' : 'color: #FEA405;'" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>
                    <span class="text-xs font-medium" :style="selectedRole === 'customer' ? 'color: #FEA405;' : 'color: #000000;'">Customer</span>
                  </div>
                </label>
              </div>
            </div>
            ...
            <div class="form-control w-full">
              ...
              <label class="label py-1">
                <span class="label-text-alt" style="color: #FEA405;">Minimum 6 characters</span>
              </label>
            </div>
            ...
            <div class="form-control">
              <label class="label cursor-pointer justify-start gap-3 py-2">
                <input v-model="agreeTerms" type="checkbox" class="checkbox" style="border-color: #FEA405; accent-color: #FEA405;" />
          ...
          <p class="text-center" style="color: #000000;">
            ...
            <router-link to="/login" class="font-semibold hover:underline" style="color: #FEA405;">
              Sign in
            </router-link>
          </p>
        </div>
